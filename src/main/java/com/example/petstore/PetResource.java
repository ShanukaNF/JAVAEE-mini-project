...
public class PetResource {
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "201", description = "Add a new Pet", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "Pet"))) })
	@POST
	@Path("/")
	@Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	public Response createPets(Pet pet) {
		int index = this.pets.size();
		int lastid = 0;
		if(index == 0) {
			lastid = 1;
		}else {
			lastid = pets.get(index-1).getPetId()+1;
		}
		Pet pet1 = pet;
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "202", description = "Delete a Pet", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "Pet"))) })
	@DELETE
	@Path("/{petId}")
	@Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "203", description = "Update Pet", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "Pet"))) })
	@PUT
	@Path("/")
	@Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "204", description = "All Pet Types", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "PetType"))) })
	@GET
	@Path("/petTypes/")
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "205", description = "Pet Type for id", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "PetType"))),
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "206", description = "Add Pet Type", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "PetType"))) })
	@POST
	@Path("/petTypes/")
	@Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "207", description = "Delete Pet Type", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "PetType"))) })
	@DELETE
	@Path("/petTypes/{petTypeId}")
	@Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "208", description = "Update Pet Type", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "PetType"))) })
	@PUT
	@Path("/petTypes/")
	@Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
